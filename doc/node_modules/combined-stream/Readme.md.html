...
combined-stream <a href="https://travis-ci.org/felixge/node-combined-stream"><img src="https://travis-ci.org/felixge/node-combined-stream.svg?branch=master" alt="Build Status"></a>
  </h1>
</div>
