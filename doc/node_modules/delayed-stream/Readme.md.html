...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#delayedstream.maxdatasize-1024-*-1024-1">delayedStream.maxDataSize = 1024 * 1024</a>
      </div>
...
<div class="pilwrap" id="delayedstream.maxdatasize-1024-*-1024-1">
  <h3>
    <a href="#delayedstream.maxdatasize-1024-*-1024-1" name="delayedstream.maxdatasize-1024-*-1024-1" class="pilcrow"></a>
delayedStream.maxDataSize = 1024 * 1024
  </h3>
</div>
<p>The amount of data to buffer before emitting an <code>error</code>.</p>
